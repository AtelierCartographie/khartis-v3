...
This project is indexed by GitNexus as **khartis-v3** (9422 symbols, 23875 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
