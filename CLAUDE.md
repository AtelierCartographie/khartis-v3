...
This project is indexed by GitNexus as **khartis-v3** (9437 symbols, 23903 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
