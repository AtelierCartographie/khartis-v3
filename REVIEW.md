...
- [x] **#166 — Forcer une colonne mixte en Nombre** _(déjà résolu)_
...
- [x] **#173 — Outil Recherche épuré** _(déjà résolu)_
...
- [x] **#184 — Carte de suggestion = Primitive · Type · Variable**
...
- [x] **Palette divergente automatique (passage par zéro)**
...
- [x] **#184 — Catégories : appliquer une palette entière**
...
- [x] **#184 — Onglets de visualisation répartis (plus de débordement)**
...
- [x] **#184 — Icônes des étapes/outils**
...
- [x] **#75 — Projections : l'interaction agit (rotation/centrage)**
...
- [x] **Filtre de primitive : Textes et Symboles dissociés** _(déjà résolu, #154/#175)_
...
- [x] **#177 — Collection de cartes (facettes)** _(travail à valider)_
...
- [x] **#184 — Outil Projection = liste simple (plus de Liste/Grille)**
...
- [x] **#156 — Territoire rendu depuis le fichier `land`**
...
- [x] **#186 — Symboles/textes suivent l'échelle de page**
      ...
      ✅ Validé Chrome local : projet `Scale186Seveso`, symboles proportionnels + textes `commune`, zoom Page 100 % puis 200 %. Preuves : `039-scale-186-page-100.png`, `041-scale-186-page-200-after-change.png`, `044-scale-186-page-100-dom.json`, `048-scale-186-page-200-applied-dom.json`.

## Étape Habillage

- [x] **#184 — Ouverture des panneaux au double-clic seulement**
...
- [x] **#172 — Annotations : isolation des points d'ancrage**
...
- [x] **#160 — Carte en encart (mini-globe)** _(cœur câblé, à valider)_
...
- [x] **#66 — Simplification : « Réinitialiser » (fond à niveaux radio)**
...
- [x] **#185 — Bouton de réinitialisation du zoom**
...
- [x] **#182 — Refonte des calques (liste unique + drag&drop)**
...
- [x] **Mode hors ligne supprimé, factory reset conservé**
...
- [x] Clore **#166** et **#173** (vérifiées résolues).
- [x] Créer 2 issues : règle palette divergente auto (**#188**) ; bugs filtre Textes/Symboles (**#189**).
