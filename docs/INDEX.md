...
> 📚 **[View Full Summary](SUMMARY.md)** - Detailed table of contents with all sections

| File              | Scope                             |
| ----------------- | --------------------------------- |
| README.md         | Entry point & golden rules        |
...
| CROSS_CUTTING.md  | Performance, a11y, security, i18n |
| UTILITIES.md      | Shared helpers overview           |
| GLOSSARY.md       | Core terms                        |
| ROADMAP.md        | Forward view                      |
