...
| Technologie                | Role                                                         |
| -------------------------- | ------------------------------------------------------------ |
| SvelteKit (Svelte 5 Runes) | Framework applicatif, rendu reactif (static adapter)         |
| TypeScript                 | Typage statique strict                                       |
| DuckDB WASM                | Moteur de requetes SQL en memoire, traitement des donnees    |
| Deck.gl                    | Rendu cartographique GPU (couches thematiques GeoArrow)      |
| MapLibre GL                | Rendu des fonds de carte tuiles (vectorielles OSM)           |
| Carbon Components Svelte   | Composants UI (IBM)                                          |
| Apache Arrow               | Format columnar en memoire, passerelle DuckDB/Deck.gl        |
