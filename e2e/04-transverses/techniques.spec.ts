...
test.describe('Performance - 3.B', () => {
  ...
  test.skip('affiche des écrans squelettes pendant le chargement', async ({ page }) => {});

  test.skip('affiche des loaders appropriés pour longues opérations', async ({ page }) => {});
  ...
  test.skip('optimise le rendu cartographique avec Deck.gl', async ({ page }) => {});

  test.skip('active l\'aperçu simplifié pour performance', async ({ page }) => {});

  test.skip('mesure le temps de premier affichage (FCP)', async ({ page }) => {});
...
test.describe('Responsive Design - 3.D', () => {
  ...
  test.skip('ajuste automatiquement l\'interface aux breakpoints', async ({ page }) => {});

  test.skip('déplace la barre d\'outils en bas sur mobile', async ({ page }) => {});

  test.skip('simplifie l\'en-tête sur mobile', async ({ page }) => {});

  test.skip('rend le panneau latéral repliable sur mobile', async ({ page }) => {});

  test.skip('adapte les boutons pour le tactile', async ({ page }) => {});

  test.skip('supporte les gestes tactiles (pinch zoom)', async ({ page }) => {});

  test.skip('supporte le glisser-déposer tactile', async ({ page }) => {});

  test.skip('adapte la taille des zones cliquables (44px minimum)', async ({ page }) => {});
});
...
test.describe('Raccourcis clavier - 3.F', () => {
  test.skip('utilise les raccourcis clavier principaux', async ({ page }) => {});
});

test.describe('Multilinguisme - 3.G', () => {
  test.skip('change la langue entre français et anglais', async ({ page }) => {});
