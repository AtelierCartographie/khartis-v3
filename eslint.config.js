...
export default ts.config(
  ...
  },
  {
    files: [
      ...
      'src/lib/features/data-tab/basemap-join-components/basemap-import-tab.svelte',
      'src/lib/features/data-tab/basemap-join-components/join-assisted-section.svelte',
      'src/lib/features/visualization/basemap-style-selector.svelte',
      'src/lib/features/visualization/choose-visualization.svelte',
      'src/lib/features/visualization/components/shared/**/*.svelte',
      'src/lib/features/visualization/components/texts/**/*.svelte',
