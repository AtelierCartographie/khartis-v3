...
export async function readGeoParquet(buffer: ArrayBuffer | Uint8Array): Promise<ArrowTable> {
...
export function extractGeoArrowMetadata(table: ArrowTable): GeoArrowMetadata | null {
