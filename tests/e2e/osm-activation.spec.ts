...
test.describe.serial(
  'TC-OSM-002: OSM join marks step 2 complete and enables Visualiser',
  () => {
    ...
    test('step 2 Joindre becomes complete and Visualiser is enabled after OSM Ajouter click', async ({
      ...
      await expect(page.locator('[data-testid="create-project-modal"] .bx--modal-container')).not.toBeVisible({
        timeout: 60000
      });
      ...
      const joindreStepLi = page.locator(
